(function () {
    ...
    angular
        ...
        .config(function ($mdIconProvider, $mdThemingProvider,$routeProvider, $locationProvider) {
            $mdIconProvider
                .defaultIconSet('img/icons/icons.svg', 24)
                .iconSet('icons',           'img/icons/icons.svg', 24)
                .iconSet('av',              'img/icons/icons.svg', 24)
                .iconSet('communication',   'img/icons/icons.svg', 24)
                .iconSet('device',          'img/icons/icons.svg', 24)
                .iconSet('editor',          'img/icons/icons.svg', 24)
                .iconSet('hardware',        'img/icons/icons.svg', 24)
                .iconSet('image',           'img/icons/icons.svg', 24)
                .iconSet('maps',            'img/icons/icons.svg', 24)
                .iconSet('notification',    'img/icons/icons.svg', 24)
                .iconSet('places',          'img/icons/icons.svg', 24)
                .iconSet('social',          'img/icons/icons.svg', 24)
                ;
